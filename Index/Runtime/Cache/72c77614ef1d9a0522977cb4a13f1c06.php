					...
					<div class="m-t-b clearfix">
												...
												<div class="col-xs-12 col-sm-6">
														<fieldset>
															...
															<div class="inner">
																...
																<p class="light-color">亲!<br/>注册在线购物用户购买商品有更多的优惠哦!</p>
													...
													<div class="col-xs-12 col-sm-12 col-md-6">
														<div class="form-group stylish-input">
															...
															<div class="col-sm-8 col-lg-8">
																<input type="text" class="form-control" id="mreceiver" value="<?php echo ($madata["receiver"]); ?>" style="width:400px;" />
															</div>
														</div>
														<div class="form-group stylish-input">
															<label for="inputLastname" class="col-sm-4 col-lg-4 control-label required">地址</label>
															<div class="col-sm-8 col-lg-8">
																<input type="text" class="form-control" id="maddr" value="<?php echo ($madata["province1"]); echo ($madata["city1"]); echo ($madata["area1"]); echo ($madata["street1"]); ?>"  style="width:400px;" />
															</div>
														</div>
														...
														<div class="form-group stylish-input">
															...
															<div class="col-sm-8 col-lg-8">
																<input type="text" class="form-control" id="memail" value="<?php echo ($madata["email"]); ?>"  style="width:400px;" />
															</div>
														</div>
														...
														<div class="form-group stylish-input">
															...
															<div class="col-sm-8 col-lg-8">
																<input type="text" class="form-control" id="mtel" value="<?php echo ($madata["tel"]); ?>" style="width:400px;" />
															</div>
														</div>
														<div class="form-group stylish-input">
															<label for="inputFax" class="col-sm-4 col-lg-4 control-label">手机号</label>
															<div class="col-sm-8 col-lg-8">
																<input type="text" class="form-control" id="mmobile" value="<?php echo ($madata["mobile"]); ?>" style="width:400px;" />
															</div>
														</div>
														<div class="form-group stylish-input">
															<label for="inputCompany" class="col-sm-4 col-lg-4 control-label">邮编</label>
															<div class="col-sm-8 col-lg-8">
																<input type="text" class="form-control" id="mpostcode" value="<?php echo ($madata["postcode"]); ?>" style="width:400px;" />
															</div>
														</div>
													</div>
												</div>
						...
						<!-- 收货人主体部分结束-->
								...
								<div class="panel panel-default" id="test">
									...
									<div id="checkout-collapse7" class="panel-collapse ">
										<div class="panel-body">
											<div class="row">
