		...
		<div class="row">
			<div class="panel panel-danger col-md-offset-2 col-md-8">
				<div class="panel-heading">
					<h3 class="panel-title">欢迎注册在线购物</h3>
				</div>
				<div class="panel-body">
					<p>在注册在线购物用户之前请务必详细阅读《用户注册协议》</p>
				</div>
				<div class="h20px"></div>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														...
														<h4 class="modal-title" id="myModalLabel">在线购物用户注册协议</h4>
													</div>
													<div class="modal-body" style="line-height:20px;">
														<h4>欢迎您注册在线购物！</h4>
														<p>特别提示：<br/>
														在使用在线购物之前，您应当认真阅读并遵守《在线购物用户协议》（以下简称“本协议”），请您务必审慎阅读、充分理解各条款内容，特别是免除或者限制责任的条款、争议解决和法律适用条款。
														</p>
														<p>免除或者限制责任的条款可能将以加粗字体显示，您应重点阅读。如您对协议有任何疑问的，应向在线购物客服咨询。
														</p>
														<p>当您按照注册页面提示填写信息、阅读并同意本协议且完成全部注册程序后，或您按照激活页面提示填写信息、阅读并同意本协议且完成全部激活程序后，或您以其他在线购物允许的方式实际使用在线购物时，即表示您已充分阅读、理解并接受本协议的全部内容，并与在线购物平台达成协议。</p>
														<p>您承诺接受并遵守本协议的约定， 届时您不应以未阅读本协议的内容或者未获得在线购物对您问询的解答等理由，主张本协议无效，或要求撤销本协议。</p>

														<ul>
														<li>
														1、本协议由您与在线购物平台的经营者共同缔结，本协议具有合同效力。
														在线购物平台的经营者是指法律认可的经营在线购物平台网站的责任主体，在线购物平台网站包括但不限于在线购物网，本协议项下各在线购物平台的经营者可单称或合称为“在线购物”。有关在线购物平台经营者的信息请查看各在线购物平台首页底部公布的公司信息和证照信息。
														</li>
														<li>
														2、除另行明确声明外，在线购物包含任何在线购物及其关联公司提供的基于互联网以及移动网的相关服务，且均受本协议约束。如果您不同意本协议的约定，您应立即停止注册/激活程序或停止使用在线购物。
														</li>
														<li>3、本协议内容包括协议正文、 法律声明、《在线购物规则》及所有在线购物已经发布或将来可能发布的各类规则、公告或通知（以下合称“在线购物规则”或“规则”）。所有规则为本协议不可分割的组成部分，与协议正文具有同等法律效力。</li>

														<li>4、在线购物有权根据需要不时地制订、修改本协议及/或各类规则，并以网站公示的方式进行变更公告，无需另行单独通知您。变更后的协议和规则一经在网站公布后，立即或在公告明确的特定时间自动生效。若您在前述变更公告后继续使用在线购物的，即表示您已经阅读、理解并接受经修订的协议和规则。若您不同意相关变更，应当立即停止使用在线购物。
														</li>
														</ul>									
													</div>
